...
heading = Label(root, text="TAREAS", font="arial 20 bold", fg="white", bg='#32405b')
...
button = Button(frame, text="+", font="arial 20 bold", width=5, bg="#5a95ff", fg="#fff", bd=0, command=addTask)
